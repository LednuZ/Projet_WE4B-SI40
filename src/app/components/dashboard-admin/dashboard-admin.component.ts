...
import { AnalyticsService, AnalyticsState } from '../../services/analytics.service';
...
export class DashboardAdminComponent implements OnInit {
  ...
  // Reactive state from BI Analytics service
  analyticsState$: Observable<AnalyticsState> = this.analyticsService.state$;
  ...
  ngOnInit(): void {
    ...
    this.loadAnnonces();
    this.loadAvis();
    this.analyticsService.updateAnalytics(30);
  }
  ...
  onJoursChange(jours: number): void {
    this.analyticsService.updateAnalytics(jours);
  }
}
